...
\begin{proof}
For the analysis, put $R=\Rquad(u)$ and $s=u-1$.  In this notation, the
...
\medskip
\noindent\textbf{Claim 1 (Parameter admissibility).}
One has $0\le b<1$, with $b=0$ only at $u=\uDet{3}$.  Indeed, since
...
\medskip
\noindent\textbf{Claim 2 (The range $\uDet{2}\le u\le2$).}
...
\medskip
\noindent\textbf{Claim 3 (The range $2\le u\le\uDet{3}$).}
