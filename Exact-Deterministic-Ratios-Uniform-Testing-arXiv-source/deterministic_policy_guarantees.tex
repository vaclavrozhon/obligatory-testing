...
$[\uDet{2},\uDet{3}]$ and then analyze the zero-prefix specialization (i.e., $b= 0$) that
is optimal until $\uDet{4}$.
...
For every $\uDet{2}\le u\le\uDet{3}$, let $R=\Rquad(u)$, $s=u-1$, and
define
\begin{equation}
 K=s^2+s+1,
 \quad D=K+sR,
