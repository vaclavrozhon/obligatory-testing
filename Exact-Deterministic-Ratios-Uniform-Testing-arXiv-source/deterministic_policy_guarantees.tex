...
\begin{proof}
For the analysis, put $R=\Rquad(u)$ and $s=u-1$, and abbreviate
\begin{equation}
 K=s^2+s+1,
 \quad D=K+sR,
 ...
 \quad \chi=\frac{1-b}{R},
 \quad \alpha=\frac KD.
 \label{eq:opt:ute-proof-parameters}
\end{equation}
...
\cref{eq:opt:ute-proof-parameters}, the latter identity is exactly
...
\end{equation}
and direct use of \cref{eq:opt:ute-proof-parameters} gives
\begin{equation}
 D[\gamma(b+\chi)-2sb]
