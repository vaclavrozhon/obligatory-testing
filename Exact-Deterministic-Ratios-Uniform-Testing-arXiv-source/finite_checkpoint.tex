\section{Finite rational checkpoint for the harmonic lower bound}
...
The phasewise shortest-first calculation behind
\cref{eq:lower-accounting} also retains favorable contributions from
individual jobs, which vanish after division by \(H^2\).  Before dropping
them it gives
\[
  \ALG_H\geq
  H^2Q_K+\frac H2
...
\end{equation}
Consequently, after recording every adaptively revealed answer on its job
label as in \cref{sec:lower}, the resulting fixed instance satisfies
\[
  \frac{\ALG_H}{\OPT_H}
  \geq
