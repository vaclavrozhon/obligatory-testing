...
We now consider blind execution.  A job that is not tested runs for its
...
$\eps_L(n)\to0$ such that every input $p\in[0,L]^n$ satisfies
\begin{equation}
...
\]
Its minimizer is $q^*=4/5$ and its value is $1249/250$.  If all tested nonzero
jobs are instead deferred until after the blind block, the best value is
$126/25$.  The gap is a positive constant at the fluid scale and therefore a
...
sequence $\eta(n)\to0$ such that every input
