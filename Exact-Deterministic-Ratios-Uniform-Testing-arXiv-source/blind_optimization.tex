...
We study randomized policies against an oblivious adversary.  This is the
natural setting for learning the input: a private random sample is
representative under every fixed labeling, whereas an adversary can make any
predetermined deterministic sample atypical.  We do not pursue a separate
deterministic worst-case curve for this model.
