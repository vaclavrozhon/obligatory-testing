\section{Optimization without revelation}
...
first, \cref{thm:bo-instance}, is the non-revealing-optimization part of the
informal instance-optimality theorem
\cref{thm:intro-instance-optimality}.  The second,
\cref{thm:bo-curve}, maximizes that instance-specific value relative to the
clairvoyant optimum.  Keeping them together avoids repeating the same
two-block reduction.
...
\eqref{eq:bo-binary-hard}, uniformly relabelled, are oblivious Yao
