...
Mathematically we allow arbitrary private probability spaces.  On each finite
input family used in a bound, only finitely many transcript decisions and
their costs are relevant, and conditioning followed by finite-support
approximation changes every expected cost by an arbitrarily small amount.
