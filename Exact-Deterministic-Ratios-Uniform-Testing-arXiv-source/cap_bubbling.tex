\section{Independent proof by moving jobs with $p=u$ to a prefix}
...
$p=u$, in the five-endpoint reduction \cref{eq:opt:five-endpoints}: it never
inserts $p=u$ into the formula for a deferred type below $u$ before the
...
threshold value, $Q$ a deferred value just above the threshold, and $U$ the
value $p=u$.  A word in these symbols records their reveal order.
