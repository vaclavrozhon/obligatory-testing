...
permutation $P_1,\ldots,P_n$ of $M$ by deferred decisions.  Equal-valued
occurrences may be kept distinct as temporary tokens.
...
selection, \cref{lem:finite-yao}, then gives the same lower bound on one fixed
