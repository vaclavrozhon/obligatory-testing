...
test--process algorithm gives $0\le\PhiOT(D^+)\le(L+1)/2$.  Apply
...
\end{equation}
The algorithm privately permutes the labels, tests the first $k$, rounds
...
schedule with the fully stationary algorithm for $\widehat J$.  The calculation
