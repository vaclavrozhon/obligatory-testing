...
\[
                         a_*\delta_{\tau_D}+\nu.
\]
The optimal realization first repeats the full maximum-density module and
...
The completion curve reaches one by normalized work at most $H=L+2$, and the immediate
