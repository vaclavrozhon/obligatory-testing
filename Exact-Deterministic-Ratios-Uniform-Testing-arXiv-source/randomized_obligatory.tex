...
For a distribution $D$ on $[0,\infty)$, let $P,P'$ be independent with law
$D$ and define
\begin{equation}
 \Omega_{\mathsf{OT}}(D)
...
\cref{eq:stationary-kernel-split}.  Then
\begin{equation}
 ...
 \label{eq:rand-KO}
\end{equation}
Rewriting the symmetric pair identity
\cref{eq:unified-opt-symmetric} as two empirical expectations, with
