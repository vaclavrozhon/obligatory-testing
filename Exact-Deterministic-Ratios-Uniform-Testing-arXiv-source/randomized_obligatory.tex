...
\end{equation}
Its fixed-cutoff specialization $\mathcal A_n^{(32)}$ satisfies the sharper
explicit estimate
\begin{equation}
...
Since $\widehat\tau\le B/2$ and
$\widehat a=(1+\widehat\ell)/\widehat\tau\ge2/B$, we have $a\ge1/B$.  For
...
For completeness, taking $B=32$ instead in the same policy reduces
\cref{eq:rand-explicit-upper} to
\[
 \EE\ALG
 \le\frac43\OPT
