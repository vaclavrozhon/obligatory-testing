...
section proves \cref{thm:random-common-upper-intro}.  The proof has three
parts.  First we analyze two policies for an announced distribution: run
everything raw, or test everything using a maximum-density stationary
threshold.  A survival-function argument shows that their worst
distribution is binary.  We then learn the better policy from a sublinear
pilot, and finally use random labellings and Yao's principle for the matching
lower bounds.
...
\cref{thm:random-common-upper-intro}.
