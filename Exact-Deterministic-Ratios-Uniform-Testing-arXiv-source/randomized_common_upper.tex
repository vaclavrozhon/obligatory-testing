...
The stationary algorithm tests all jobs in a uniform random order, processes a
...
stationary maximum-density algorithm.  Hence
\begin{equation}
...
\begin{proof}
Expose values at first touch, apply the same uniform-prefix sampling event,
