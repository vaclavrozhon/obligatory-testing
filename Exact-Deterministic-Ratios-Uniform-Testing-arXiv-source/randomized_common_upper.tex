...
histograms.  The histogram estimate
...
Take $\delta_n=n^{-1/4}$.  The uniform-prefix bound
\cref{eq:uniform-prefix-hoeffding}, followed by the maximal martingale bound
\cref{eq:maximal-azuma} for the predictably selected tests,
...
Yao selection \cref{lem:finite-yao}.  Since $u>3$, the two effective lengths are one and
