...
clairvoyant job has effective length $1+\min\{s,P\}$, layer cake and the
symmetric pair identity \cref{eq:unified-opt-symmetric} give, for
$P_p\sim D[p]$,
\begin{align}
...
policy of \cref{thm:common-upper-instance} to $D=D[p]$.  The endpoint
...
averaging over the policy seed.  Since $u>3$, the two effective lengths
