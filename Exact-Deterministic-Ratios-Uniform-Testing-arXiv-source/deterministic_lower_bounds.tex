...
\medskip
\noindent\textbf{Claim 1 (Adversarial reveal order and replay).}
...
If every job mass is multiplied by a common factor, the phase accounting,
harmonic cancellation, and completion of squares in
...
rational approximations, clear their denominators, and apply the replay
argument from the theorem.  This produces arbitrarily large fixed rational
instances with the stated limit and liminf bounds.
\end{proof}
...
harmonic core: it first reveals a prescribed fraction of jobs with $p=u$ and
then reveals the multilevel cap-free instance from the preceding subsection.
...
still being tested.  Let $q$ be their normalized mass.  Their pairs with all
later jobs add
...
online coefficient, and total positive processing mass of the later
...
contributes $2+p$ online and $1+p$ offline.  Summed over cap mass $m$ and
later mass $1-m$, these give the cross terms involving $m(1-m)$ and $mL$.
