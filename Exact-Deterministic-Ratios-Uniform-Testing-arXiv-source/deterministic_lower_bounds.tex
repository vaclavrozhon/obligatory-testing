...
leading normalized excess $2(\ALG-R\OPT)/n^2$ at its stopping time is,
up to $O_u(1/n)$,
\begin{equation}
...
coefficient $A^{\rm lb}-R\,O$ obtained from the capped prefix and
the later block in
...
$A-(1+c)O=0$.  Combining this equality with the two vanishing partial
derivatives gives
\begin{equation}
 \ln t=u-2-\frac1c,
 \qquad
