...
\begin{proof}
For $1<u\le \udiam$, use $R=u$ and the maximizing point of
\cref{eq:opt:stopping-positive-branch}.  For
$\udiam\le u\le \uzero$, use the positive root $\Rquad(u)$ and
...
\subsubsection{The large-upper-limit lower bound by cap-free transfer}
