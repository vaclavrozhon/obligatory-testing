...
misses an extremely long job, but this is the whole algorithmic picture.  In
particular, the randomized algorithm is not told the multiset of lengths, and
the guarantee holds even when the $p_i$ are unbounded.
