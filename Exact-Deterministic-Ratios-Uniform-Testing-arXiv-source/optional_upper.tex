...
\]
and $\zstar>1$ is the solution of $\zstar-3=\ln \zstar$.  We also set
\[
 r=\frac{2}{\zstar-1}.
\]
...
\[
 \bar p_i=\min\{p_i,u-1\}.
\]
By \cref{eq:optional-effective-length,lem:offline}, the clairvoyant optional
...
\begin{equation}
 \operatorname{ALG}-R\operatorname{OPT}
 =\Gamma_n-c\binom n2
